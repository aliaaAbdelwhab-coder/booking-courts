           ...
           <form method= "post" action="booking_insert.php">
                <div id="form-body">
                    ...
                    <label> where do you want to play ?:</label><br>
                      <label>
                    <input type = "radio" name="place_of_play" value="handball court"> <label>handballcourt</label>
                    <input type = "radio" name="place_of_play" value="football court"> <label>football court</label>
